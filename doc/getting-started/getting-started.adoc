...
- axway.deploy.group
- axway.container.scripts
- axway.remove.container
- axway.container.name
- axway.remove.image
- axway.image.name
- axway.image.tag
- axway.parent.image.name
- axway.parent.image.tag
- axway.license
- axway.merge.dir
...
In the following example, we will delete the existing container and image, then we will recreate everything.
