...
Clone the repository on your machine, switch to _develop_ branch and install the plugin:
...
The plugin requires the installation of the Axway API Gateway development and deployment tools.
...
Now the build succeeds and a deployment archive `hello-world-dev-0.1.0-SNAPSHOT.axdar` containing the .pol, .env and .fed files will be created.
